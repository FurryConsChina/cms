  ...
  return (
    <div>
      ...
      <Flex vertical gap={8}>
        ...
        >
          <Input placeholder="请输入展会名称" {...form.register("name")} />
        </Form.Item>
                ...
                render={({ field }) => (
                  <OrganizationSelector
                    ...
                    onSelect={(value) => {
                      ...
                      field.onChange(
                        value?.map((org: Organization) => org.id) || []
                      );
                    }}
                  />
                )}
          ...
          <Col flex={1}>
            <Form.Item
              ...
              help={
                ...
                "除非明确知晓展会开始时间，否则请保持默认上午10点"
              }
              validateStatus={
                form.formState.errors.startAt ? "error" : undefined
              }
            >
              <Controller
                name="startAt"

            ...
            <Card title={`信息来源 ${index + 1}`}>
              <Row gutter={8} align="bottom">
                <Col flex={1}>
                  ...
                  >
                    <Input placeholder="信息来源名称" {...form.register(`sources.${index}.name`)} />
                  </Form.Item>
                </Col>
                <Col flex={1}>
                  <Form.Item
                  ...
                  >
                    <Input placeholder="信息来源链接" {...form.register(`sources.${index}.url`)} />
                  </Form.Item>
                </Col>
                <Col flex={1}>
                  <Form.Item
                  ...
                  >
                    <Input placeholder="信息来源描述（可选）" {...form.register(`sources.${index}.description`)} />
                  </Form.Item>
                </Col>
                <Col>
                  <Flex gap={4}>
                    ...
                    />
                    <Button size="small" danger icon={<IconTrash size={14} />} onClick={() => remove(index)} />
                  </Flex>
                </Col>
              </Row>
            </Card>
